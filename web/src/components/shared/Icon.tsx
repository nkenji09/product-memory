...
const ICONS = {
  ...
  // Kebab (⋮) trigger for the tag/vocab affordance menu (card-affordance-menu).
  'ellipsis-vertical': [
    { tag: 'circle', cx: 12, cy: 12, r: 1, fill: 'currentColor' },
    { tag: 'circle', cx: 12, cy: 5, r: 1, fill: 'currentColor' },
    { tag: 'circle', cx: 12, cy: 19, r: 1, fill: 'currentColor' },
  ],
  list: [
    { tag: 'path', d: 'M3 5h.01' },
