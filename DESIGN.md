...
| 11 | 機械的意味論の宣言 | kind の behaviors/description・ownerKind（後フェーズ・P9） |
...
# 語彙
scholia vocab add <condition|action|effect> <id> --label <l> [--kind <k>] [--owner <l>] [--ref <a>] [--alt-label <t>]… [--establishes <condId>]…  # ref/altLabels/establishes は #45 D5（establishes は effect のみ・実在検証）
scholia vocab edit <id> [--label <l>] [--description <d>|--desc-file <f>|--edit] [--ref <a>] [--alt-label <t>]… [--clear-alt-labels] [--establishes <condId>]… [--clear-establishes]  # --label は空不可
